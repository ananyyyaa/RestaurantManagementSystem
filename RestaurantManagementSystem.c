...
int main()
{
    heada = createadmin(heada,1,"Hot and Sour Soup",50);
    heada = createadmin(heada,2,"Manchow Soup",60);
    heada = createadmin(heada,3,"Manchurian Noodles",90);
    heada = createadmin(heada,4,"Fried Rice",70);
    heada = createadmin(heada,5,"Hakka Noodles",120);
